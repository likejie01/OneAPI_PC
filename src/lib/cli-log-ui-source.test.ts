...
test('wallet recharge area splits redemption and server-created payment entry', () => {
  ...
  assert.match(walletDomainSource, /platform:\s*'pc'/)
  assert.match(walletDomainSource, /pay_scene:\s*'pc_qr'/)
  assert.match(walletDomainSource, /pay_product:\s*'alipay\.trade\.precreate'/)
  assert.match(walletDomainSource, /payment_product:\s*'alipay\.trade\.precreate'/)
  assert.match(walletDomainSource, /response\.data\.qr_code/)
  assert.match(walletDomainSource, /\/api\/user\/alipay\/cancel/)
