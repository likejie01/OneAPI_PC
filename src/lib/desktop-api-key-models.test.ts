...
const models: ChatModelOption[] = [
  ...
  { label: 'deepseek-v4-flash-max', value: 'deepseek-v4-flash-max' },
  { label: 'deepseek-v4-pro', value: 'deepseek-v4-pro', enableGroups: ['1.10 DeepSeek / Xiaomi MIMO官方'] },
  { label: 'deepseek-v4-pro-max', value: 'deepseek-v4-pro-max' },
...
test('all channel group keys keep all available models', () => {
  assert.deepEqual(
    ...
    ['gpt-5.5', 'deepseek-v4-flash', 'deepseek-v4-flash-max', 'deepseek-v4-pro', 'deepseek-v4-pro-max', 'mimo-v2.5-pro', 'xiaomimimo-v2.5-pro', 'gemini-2.5-pro']
  )
})
...
test('specific group keys keep matching described, canonical, and known bridge models', () => {
  assert.deepEqual(
    ...
    ['deepseek-v4-flash', 'deepseek-v4-flash-max', 'deepseek-v4-pro', 'deepseek-v4-pro-max', 'mimo-v2.5-pro', 'xiaomimimo-v2.5-pro']
  )
})
...
test('multi group keys union models from each selected group', () => {
  assert.deepEqual(
    ...
    ['gpt-5.5', 'deepseek-v4-flash', 'deepseek-v4-flash-max', 'deepseek-v4-pro', 'deepseek-v4-pro-max', 'mimo-v2.5-pro', 'xiaomimimo-v2.5-pro']
  )
})
